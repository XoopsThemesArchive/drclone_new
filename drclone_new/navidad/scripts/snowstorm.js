...
function SnowStorm() {
  ...
  var usePNG = true;
  var imagePath = 'http://www.drclone.net/themes/drclone_new/snow/'; // relative path to snow images
  var flakeTypes = 6;
  var flakesMax = 128;
  ...
  var flakeWidth = 5;
  var flakeHeight = 5;
  var flakeBottom = 95; // Integer for fixed bottom, 0 or null for "full-screen" snow effect
